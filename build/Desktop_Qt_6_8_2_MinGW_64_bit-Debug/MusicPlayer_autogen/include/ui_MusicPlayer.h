...
"}"));
        volumeBar = new QSlider(MusicPlayer);
        volumeBar->setObjectName("volumeBar");
        volumeBar->setEnabled(true);
        volumeBar->setGeometry(QRect(250, 560, 91, 20));
...
"}"));
        ...
        layoutWidget->setGeometry(QRect(9, 9, 341, 541));
...
"}"));
    ...
    void retranslateUi(QWidget *MusicPlayer)
    {
        ...
        volumeBar->setToolTip(QCoreApplication::translate("MusicPlayer", "\351\237\263\351\207\217\346\235\241", nullptr));
#endif // QT_CONFIG(tooltip)
        playDurLab->setText(QCoreApplication::translate("MusicPlayer", "00:00:00", nullptr));
        label_3->setText(QCoreApplication::translate("MusicPlayer", "/", nullptr));
        durationLab->setText(QCoreApplication::translate("MusicPlayer", "00:00:00", nullptr));
#if QT_CONFIG(tooltip)
        playSlider->setToolTip(QCoreApplication::translate("MusicPlayer", "\346\222\255\346\224\276\350\277\233\345\272\246\346\235\241", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        openDirBtn->setToolTip(QCoreApplication::translate("MusicPlayer", "\346\211\223\345\274\200\346\226\207\344\273\266\345\244\271", nullptr));
#endif // QT_CONFIG(tooltip)
        openDirBtn->setText(QString());
#if QT_CONFIG(tooltip)
        prevBtn->setToolTip(QCoreApplication::translate("MusicPlayer", "\344\270\212\344\270\200\351\246\226", nullptr));
#endif // QT_CONFIG(tooltip)
        prevBtn->setText(QString());
#if QT_CONFIG(tooltip)
        playBtn->setToolTip(QCoreApplication::translate("MusicPlayer", "\346\222\255\346\224\276", nullptr));
#endif // QT_CONFIG(tooltip)
        playBtn->setText(QString());
#if QT_CONFIG(tooltip)
        nextBtn->setToolTip(QCoreApplication::translate("MusicPlayer", "\344\270\213\344\270\200\351\246\226", nullptr));
#endif // QT_CONFIG(tooltip)
        nextBtn->setText(QString());
#if QT_CONFIG(tooltip)
        volumeBtn->setToolTip(QCoreApplication::translate("MusicPlayer", "\351\237\263\351\207\217", nullptr));
#endif // QT_CONFIG(tooltip)
